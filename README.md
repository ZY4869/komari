...
![Badge](https://hitscounter.dev/api/hit?url=https%3A%2F%2Fgithub.com%2FZY4869%2Fkomari&label=&icon=github&color=%23a370f7&message=&style=flat&tz=UTC)
[![Ask DeepWiki](https://deepwiki.com/badge.svg)](https://deepwiki.com/ZY4869/komari)
...
1. Visit Komari's [GitHub Release page](https://github.com/ZY4869/komari/releases) to download the latest binary for your operating system.
2. Run Komari:
   ```bash
